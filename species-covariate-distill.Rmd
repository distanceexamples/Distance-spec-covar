...
In Buckland's [-@Buckland2006] line transect survey, three of the four songbird species (c-chaffinch, g-great tit, r-robin, w-winter wren) were detected in sufficient quantities that sample size is not an issue.  However, the great tit was only detected 32 times, making the support for this species questionable.
...
```{r plotcode, out.width="80%", fig.retina=4, fig.cap="Species-specific detection functions.  Base (intercept) species is chaffinch." }
plot.with.covariates <- function(dsobject) {
  ...
  plot(dists, xx[,1], type='l', lty=1, ylim=c(0,1),
       ...
       main="Detection function for levels of factor covariate")
  ...
  legend("topright", legend=attr(myobject$scale$dm, "dimnames")[[2]],
         lty=seq(1:covar.levels), cex=0.75,
...
```{r screenclip, out.width="80%", fig.cap="Reproduction of Table 2 of Buckland (2006).", echo=FALSE}
